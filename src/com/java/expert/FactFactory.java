...
public class FactFactory {
    ...
    public static IFact Fact(String factStr){
        ...
        if (factStr.contains("=")){
            ...
            ArrayList<String> nameValue = new ArrayList<>(Arrays.asList(nameVal));
            ...
            if (nameValue.size() >= 2){
                ...
                return new StringFact(nameValue.get(0).trim(), nameValue.get(1).trim(), question, 0);
            }
            else return null;
        }
        else {
            ...
            String[] nameVal = factStr.split("[=()]");
            ArrayList<String> nameQuestion = new ArrayList<>(Arrays.asList(nameVal));
